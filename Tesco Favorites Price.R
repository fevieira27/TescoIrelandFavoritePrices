...
#loop through the number of available pages, currently setup for 3 pages. Please change the middle number in seq function to your number of pages: 1 page=0, 2 pages=100, 3 pages=200, 4 pages=300, etc.
...
# if number os rows is an exact hundred (100, 200, 300), it is very likely that you're missing following pages. Please adjust the seq function in the for loop
nrow(results)
...
# Please change the destination folder of the file. I've decided to keep the timestamp in order to mantain history of the prices, for future comparison and dashboard creation
write.csv(results,paste0("D:\\New\\tesco_
",currtime ,".csv"), row.names = TRUE)
